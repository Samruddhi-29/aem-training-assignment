 ...
 */
package com.training.assignment.core.models;
...
import com.training.assignment.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "assignmentaemtraining/components/helloworld");
